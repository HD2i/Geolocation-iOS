//
//  WalletGenerationViewController.swift
//  Geolocation
//
...
class WalletGenerationViewController: UIViewController,
QRCodeReaderViewControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        titleLabel.text = creationType.title()
    ...
    func createWallet() {
        ...
        walletGenerationController.createWallet(with: creationType, password: passwordTextField.text, key: enterPrivateKeyTextField.text) { (error) in
            guard error == nil else {
                self.alerts.show(error, for: self)
                return
            }
            self.performSegue(withIdentifier: "enterMain", sender: nil)
        }
...
extension WalletGenerationViewController: UITextFieldDelegate {
